...
#
# $Id: //lyengine/branches/AWSIntegration/Tools/lmbr_aws/AWSResourceManager/default-content/project-code/test/test_deployment_configuration.py#2 $
...
class TestDeploymentConfiguration(unittest.TestCase):
    ...
    def test_handler(self):
        ...
        with mock.patch.object(custom_resource_response, 'succeed') as mock_custom_resoruce_response_succeed:
            deployment_configuration.handler(self.event, self.context)
